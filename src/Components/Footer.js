        ...
        <div className="row">
          ...
          <div className="col-md-3">
            ...
            {isHomePage ? (
                <>
                  <li>
                    <ScrollLink className='scrl'to="home" smooth={true} duration={500} >Home</ScrollLink>
                  </li>
                  <li>
                    <ScrollLink  className='scrl'to="product" smooth={true} duration={500} >Products</ScrollLink>
                  </li>
                  <li>
                    <ScrollLink  className='scrl'to="about" smooth={true} duration={500} >About</ScrollLink>
                  </li>
                </>
              ) : (
      ...
      <div className="bg-secondary py-3">
        <div className="container text-center">
          <p className="mb-0">Copyright © {new Date().getFullYear()}
            <a href="/#home" className="text-white"> 火 Go-kART </a>
          </p>
        </div>
      </div>
    </footer>
